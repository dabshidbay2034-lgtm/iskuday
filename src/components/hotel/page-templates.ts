...
const BEACHFRONT_LOOK: Look = {
  ...
  hours: { align: "center", width: "narrow", tone: "plain", pad: "normal" },
  location: { align: "center", width: "narrow", tone: "plain", pad: "normal" },
  ...
  events: { columns: 3, width: "wide", pad: "normal" },
  reviews: { columns: 3, width: "wide", pad: "normal" },
...
const BUSINESS_LOOK: Look = {
  ...
  hours: { align: "left", width: "narrow", tone: "card", pad: "normal" },
  location: { align: "left", width: "narrow", tone: "card", pad: "normal" },
...
const BOUTIQUE_LOOK: Look = {
  ...
  hours: { align: "center", width: "narrow", tone: "tinted", pad: "roomy" },
  location: { align: "center", width: "narrow", tone: "tinted", pad: "roomy" },
  ...
  events: { columns: 2, width: "narrow", pad: "roomy" },
  reviews: { columns: 2, width: "narrow", pad: "roomy" },
